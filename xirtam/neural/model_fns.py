...
def resnet50_16s_fn(n_classes, model_input=None):
    # load 32s base model
    base_model, stride = resnet50_fn(n_classes)
...
def resnet50_8s_fn(n_classes, model_input=None):
    # load 16s base model
    base_model, stride = resnet50_16s_fn(n_classes)
