...
def TimTamNet(input_shape=(128, 128, 1)):
    ...
    timtamnet.add(Conv2D(64, (3, 3), padding="same", activation="relu", input_shape=input_shape))
    timtamnet.add(Conv2D(64, (3, 3), padding="same", activation="relu"))
    timtamnet.add(Conv2D(64, (3, 3), padding="same", activation="relu"))
    timtamnet.add(MaxPooling2D((2, 2), strides=(2, 2)))
    timtamnet.add(Conv2D(128, (3, 3), padding="same", activation="relu"))
    timtamnet.add(Conv2D(128, (3, 3), padding="same", activation="relu"))
    timtamnet.add(Conv2D(128, (3, 3), padding="same", activation="relu"))
    timtamnet.add(MaxPooling2D((2, 2), strides=(2, 2)))
    timtamnet.add(Conv2D(256, (3, 3), padding="same", activation="relu"))
    timtamnet.add(Conv2D(256, (3, 3), padding="same", activation="relu"))
    timtamnet.add(Conv2D(256, (3, 3), padding="same", activation="relu"))
