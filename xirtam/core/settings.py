...
OUTPUT_DEFAULT_COLOUR = 0
OUTPUT_VALID_COLOUR = MAX_PERMEABILITY_COLOUR
OUTPUT_INVALID_COLOUR = MIN_PERMEABILITY_COLOUR
OUTPUT_DEFAULT_LABEL = 0
OUTPUT_VALID_LABEL = 1
OUTPUT_INVALID_LABEL = 2
